...
#else
                    // When using the .unitypackage distribution mode,
                    // we assume the SDK is always installed, so this should never trigger.
                    // Keep a minimal log message just in case
                    Debug.LogWarning(
